      ...
      <div className="homeabout-content-wrapper">
        ...
        <div className="homeabout-main-flex">
          ...
          <div className="homeabout-about-card">
            ...
            <h3 className="homeabout-about-title">ABOUT ME</h3>
            <p className="homeabout-about-text">
              Shri Vishal Raj (IAS) is the current District Magistrate and Collector of Kishanganj, Bihar. The District Magistrate (DM) ensures law and order, supervises government departments, and implements state and central welfare schemes through regular field visits.
              </p>
          </div>
            ...
            <div className="homeabout-cards-grid">
              ...
              <div className="homeabout-travel-item">
                ...
                <div className="homeabout-card-content">
                  ...
                  <button className="homeabout-btn">
                    READ MORE
                  </button>
                </div>
              </div>
