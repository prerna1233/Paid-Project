        ...
        <div className="hotel-main-info">
          ...
          <div className="hotel-pricing">
            ...
            <div className="price-info">
              <div className="main-price">₹{hotel.price.toLocaleString()}</div>
              <div className="original-price">₹{Math.round(hotel.price * 1.8).toLocaleString()}</div>
              <div className="price-source">lastminute.com</div>
            </div>
            <button 
