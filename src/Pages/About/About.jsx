  ...
  return (
    <>
      ...
      <div className="heading1">
        <h1>Leadership &  Administeration</h1>
      </div>
    ...
    <div className="disigners">
      <div className="figma">
        ...
        <p>Our Foigma designers Team focuses on clean , accessible, and user-friendly interfaces for digital platform <span> Moni Kumari , Sweta , Suman</span> collaboratively design structured  layouts, mantain visual 
