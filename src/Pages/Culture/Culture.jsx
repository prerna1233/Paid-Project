  ...
  return (
    <div className="culture-hero">
      ...
      <div className='jhijiya main-info'>
        <img src='src/assets/jhijhiya.jpeg' alt='Jhijhiya-dance' className='culture-img' />
      ...
      <div className='chatpuja  main-info'>
        <img src='src/assets/chatpuja.jpeg' alt='chatpuja-dance' className='culture-img' />
      ...
      <div className='jhijhiya main-info'>
        <img src='src/assets/pineapple.jpeg' alt='pineapple' className='culture-img' />
